...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FunctionalArea.active'
        db.add_column('profiles_functionalarea', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FunctionalArea.active'
        db.delete_column('profiles_functionalarea', 'active')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
